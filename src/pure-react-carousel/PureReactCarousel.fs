...
type carouselProviderProps =
    static member naturalSlideHeight (value: int) = Interop.mkAttr "naturalSlideHeight" value
    static member naturalSlideWidth (value: int) = Interop.mkAttr "naturalSlideWidth" value
    static member totalSlides (value: int) = Interop.mkAttr "totalSlides" value
    static member children (elements: ReactElement seq) = prop.children elements
...
[<Erase>]
type slideProps =
    static member index (value: int) = Interop.mkAttr "index" value
    static member children (elements: ReactElement seq) = prop.children elements
